...
async def route_with_mistral(message: str, session_context: dict) -> str:
    ...
    Delegates to the modular routing module which uses semantic routing
    when enabled, with fallback to pattern-based routing.

    Returns:
        'needs_tools' - Route to OpenAI with tools for data analysis
        'can_answer' - Let Arena handle the response
