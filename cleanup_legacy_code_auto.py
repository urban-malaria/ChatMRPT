#!/usr/bin/env python
"""
Automatic cleanup script for legacy code in the ChatMRPT project.
This script will identify and clean up legacy code, including ai_utils.py.
It automatically removes all legacy files without prompting.
"""
...
def main():
    """Main entry point."""
    print("=" * 60)
    print("Automatic Legacy Code Cleanup")
    print("=" * 60)
    ...
    if legacy_files:
        print("\nAutomatically removing legacy files...")
